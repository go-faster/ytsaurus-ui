...
import {AccountActionsField} from './AccountActionsField';
import {
    AccountRequestData,
    showAccountAttribute,
} from '../../../../store/actions/accounts/attributes';
...
function useColumnsByPreset(mediums: Array<string>) {
    ...
    const handleAttributeButtonClick = useCallback(
        (accountData: AccountRequestData) => {
            dispatch(showAccountAttribute(accountData));
        },
        [dispatch],
    );
